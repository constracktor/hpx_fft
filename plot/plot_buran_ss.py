...
ss_fftw_mpi_omp_matrix = np.genfromtxt(os.path.abspath('./plot/data/strong_scaling/buran/strong_runtimes_fftw_mpi_omp.txt'), dtype='float', delimiter=';' , skip_header=1)
...
ss_fftw_mpi_total_matrix = np.genfromtxt(os.path.abspath('./plot/data/strong_scaling/buran/strong_runtimes_fftw_mpi_total.txt'), dtype='float', delimiter=';' , skip_header=1)
