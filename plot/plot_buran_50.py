...
# ss_loop_48_lci_matrix = np.genfromtxt(os.path.abspath('./plot/data/strong_scaling/buran/strong_runtimes_hpx_loop_48_lci.txt'), dtype='float', delimiter=';' , skip_header=1)
...
# for i in range (n_entries):
#     ss_loop_48_lci_averaged[i,:] = np.mean(ss_loop_48_lci_matrix[i*n_loop:(i+1)*n_loop,:],axis=0)
...
# ss_task_agas_48_lci_matrix = np.genfromtxt(os.path.abspath('./plot/data/strong_scaling/buran/strong_runtimes_hpx_task_agas_48_lci.txt'), dtype='float', delimiter=';' , skip_header=1)
...
# for i in range (n_entries):
#     ss_task_agas_48_lci_averaged[i,:] = np.mean(ss_task_agas_48_lci_matrix[i*n_loop:(i+1)*n_loop,:],axis=0)  
...
# HPX loop dist data
plt.plot(points, ss_loop_48_averaged[:,7], 's-', c=colors[3], linewidth=2, label='HPX for_loop dist')
# # HPX loop dist data
# plt.plot(points, ss_loop_48_lci_averaged[:,7], 's-', c=colors[5], linewidth=2, label='HPX for_loop dist lci')
# HPX task agas dist data
plt.plot(points, ss_task_agas_48_averaged[:,7], 'o-', c=colors[5], linewidth=2, label='HPX future agas dist')
# # HPX task agas dist data
# plt.plot(points, ss_task_agas_48_lci_averaged[:,7], 'o-', c=colors[7], linewidth=2, label='HPX future agas dist lci')
