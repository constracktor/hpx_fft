...
module load llvm/17.0.1 boost/1.83.0 hwloc/2.9.1 openmpi/4.1.5
# structure
...
cmake -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_INSTALL_PREFIX=$DIR_INSTALL -DHPX_WITH_MALLOC=tcmalloc -DHPX_WITH_PARCELPORT_TCP=OFF -DHPX_WITH_PARCELPORT_MPI=ON -DHPX_WITH_NETWORKING=ON -DHPX_WITH_CXX_STANDARD=20 -DHPX_WITH_FETCH_ASIO=ON -DHPX_WITH_EXAMPLES=OFF -DHPX_WITH_TESTS=OFF ../src
