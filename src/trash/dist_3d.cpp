...
// localities
//
hpx::partitioned_vector<double> va;
///////////////////////////////////////////////////////////////////////////////
//[hello_world_worker
std::size_t hello_world_worker(std::size_t desired)
{
    ...
    if (current == desired)
    {
        ...
        char const* msg = "From OS-thread {1} on locality {2} get element of partitioned vector: {3}\n";

        hpx::util::format_to(hpx::cout, msg, desired, hpx::get_locality_id(), va[hpx::get_locality_id()])
            << std::flush;
...
int hpx_main(hpx::program_options::variables_map& vm)
{
    ...
    std::cout << "All localities: " << hpx::get_num_localities().get() << std::endl;
    // Get all localities
    //std::cout << "Local localities: " << hpx::get_num_localities() << std::endl;
    // Get all remote localities
    std::cout << "Remote localities: " << hpx::find_all_localities().size() << std::endl;
